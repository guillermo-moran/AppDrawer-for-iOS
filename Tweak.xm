...
-(UIView*)drawerAppIconWithIdentifier:(id)kek {
    ...
    //dispatch_queue_t drawer_queue = dispatch_queue_create("drawer_queue", NULL);
    //dispatch_async(drawer_queue, ^{
...
-(void)loadInstalledApps {
    ...
    //iOS 10
    if ([appsDictionary objectForKey:@"com.apple.DiagnosticsService"]) {
        [appsDictionary removeObjectForKey:@"com.apple.DiagnosticsService"];
    }

    if ([appsDictionary objectForKey:@"com.apple.ScreenSharingViewService"]) {
        [appsDictionary removeObjectForKey:@"com.apple.ScreenSharingViewService"];
    }

    if ([appsDictionary objectForKey:@"com.apple.SharingViewService"]) {
        [appsDictionary removeObjectForKey:@"com.apple.SharingViewService"];
    }

    if ([appsDictionary objectForKey:@"com.apple.VSViewService"]) {
        [appsDictionary removeObjectForKey:@"com.apple.VSViewService"];
    }

    if ([appsDictionary objectForKey:@"com.apple.WatchListViewService"]) {
        [appsDictionary removeObjectForKey:@"com.apple.WatchListViewService"];
    }

    if ([appsDictionary objectForKey:@"com.apple.appleseed.FeedbackAssistant"]) {
        [appsDictionary removeObjectForKey:@"com.apple.appleseed.FeedbackAssistant"];
    }

    if ([appsDictionary objectForKey:@"com.apple.GameController2"]) {
        [appsDictionary removeObjectForKey:@"com.apple.GameController2"];
    }

    //iOS 11

    if ([appsDictionary objectForKey:@"com.apple.ChargingViewService"]) {
        [appsDictionary removeObjectForKey:@"com.apple.ChargingViewService"];
    }

    if ([appsDictionary objectForKey:@"com.apple.CheckerBoard"]) {
        [appsDictionary removeObjectForKey:@"com.apple.CheckerBoard"];
    }

    if ([appsDictionary objectForKey:@"com.apple.CTCarrierSpaceAuth"]) {
        [appsDictionary removeObjectForKey:@"com.apple.CTCarrierSpaceAuth"];
    }

    if ([appsDictionary objectForKey:@"com.apple.carkit.DNDBuddy"]) {
        [appsDictionary removeObjectForKey:@"com.apple.carkit.DNDBuddy"];
    }

    if ([appsDictionary objectForKey:@"com.apple.FTMInternal"]) {
        [appsDictionary removeObjectForKey:@"com.apple.FTMInternal"];
    }

    if ([appsDictionary objectForKey:@"org.coolstar.SafeMode"]) {
        [appsDictionary removeObjectForKey:@"org.coolstar.SafeMode"];
    }

    if ([appsDictionary objectForKey:@"com.apple.ScreenshotServicesService"]) {
        [appsDictionary removeObjectForKey:@"com.apple.ScreenshotServicesService"];
    }

    if ([appsDictionary objectForKey:@"com.apple.susuiservice"]) {
        [appsDictionary removeObjectForKey:@"com.apple.susuiservice"];
    }

    if ([appsDictionary objectForKey:@"com.apple.WLAccessService"]) {
        [appsDictionary removeObjectForKey:@"com.apple.WLAccessService"];
    }

    if ([appsDictionary objectForKey:@"com.apple.Magnifier"]) {
        [appsDictionary removeObjectForKey:@"com.apple.Magnifier"];
    }

    //iOS 12
    if ([appsDictionary objectForKey:@"com.apple.AXUIViewService"]) {
        [appsDictionary removeObjectForKey:@"com.apple.AXUIViewService"];
    }
    if ([appsDictionary objectForKey:@"com.apple.ContinuityCamera"]) {
        [appsDictionary removeObjectForKey:@"com.apple.ContinuityCamera"];
    }
    if ([appsDictionary objectForKey:@"com.apple.AdPlatformsDiagnostics"]) {
        [appsDictionary removeObjectForKey:@"com.apple.AdPlatformsDiagnostics"];
    }
    if ([appsDictionary objectForKey:@"com.apple.SIMSetupUIService"]) {
        [appsDictionary removeObjectForKey:@"com.apple.SIMSetupUIService"];
    }
...
-(void)launchAppFromDrawer:(id)application {
    ...
    if (IS_OS_11_OR_LATER) {
        [self activateApplication:app fromIcon:nil location:nil activationSettings:nil actions:nil];
    }
